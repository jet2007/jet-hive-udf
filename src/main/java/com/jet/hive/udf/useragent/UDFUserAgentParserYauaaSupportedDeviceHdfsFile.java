...
public class UDFUserAgentParserYauaaSupportedDeviceHdfsFile extends GenericUDF {

	//private PrimitiveObjectInspector inputOI;
    private StringObjectInspector stringOI = null;
    private static UserAgentAnalyzer userAgentAnalyzer = null;
    //private static MobileModelParse mobileModelParse = null;
    ...
    public ObjectInspector initialize(ObjectInspector[] args) throws UDFArgumentException {
        ...
        // Initialize
        constructAnalyzer();
        if(args.length<3){//1,2个参数时，从本jar包的资源文件读取
